 ...
 */
public class GardienDisplayActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gardien_display);
        new DownloadJSONg().execute();
    }

    // DownloadJSON AsyncTask
    private class DownloadJSONg extends AsyncTask<Void, Void, Void> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(GardienDisplayActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL("http://ultimate-team-star.16mb.com/jsonutsg.txt");
        ...
        protected void onPostExecute(Void args) {
            ...
            adapter = new ListViewAdapter(GardienDisplayActivity.this, arraylist);
    ...
    public void buttonOnClickhelp(View v) {
        ...
        CharSequence text= "Voici une sélection de gardiens internationaux, vous avez la possibilité de télécharger les images de ces footballeurs en leur cliquant dessus !";
