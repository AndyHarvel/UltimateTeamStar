 ...
 */
public class AttaquantDisplayActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.attaquant_display);
    ...
    private class DownloadJSONa extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(AttaquantDisplayActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL("http://ultimate-team-star.16mb.com/jsonuts.txt");
        ...
        protected void onPostExecute(Void args) {
            ...
            adapter = new ListViewAdapter(AttaquantDisplayActivity.this, arraylist);
    ...
    public void buttonOnClickhelp(View v) {
      ...
      //ce code génère un TOAST - Jalil !
        ...
        CharSequence text= "Voici une sélection d'attaquants internationaux, vous avez la possibilité de télécharger les images de ces footballeurs en leur cliquant dessus !";
