 ...
 */
public class MillieuDisplayActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.millieu_display);
        new DownloadJSONm().execute();
    }

    private class DownloadJSONm extends AsyncTask<Void, Void, Void> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(MillieuDisplayActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL("http://ultimate-team-star.16mb.com/jsonutsm.txt");
        ...
        protected void onPostExecute(Void args) {
            ...
            adapter = new ListViewAdapter(MillieuDisplayActivity.this, arraylist);
    ...
    public void buttonOnClickhelp(View v) {
        ...
        CharSequence text= "Voici une sélection de millieux internationaux, vous avez la possibilité de télécharger les images de ces footballeurs en leur cliquant dessus !";
